async function variables(){
    ...
    queries = [datapoint.peso]
    return queries
}

variables().then(datapoint =>{
    const names = datapoint[0].map(data =>{
        return data.name
    })
    ...
    const config = {
        ...
        var ctx = document.getElementById('myChart_weight_enterprise').getContext('2d');
